...
import { 
  ...
  Users, Building, Music, Flag, Info, XCircle
} from 'lucide-react';
...
const HERO_SLIDES = [
  "https://images.unsplash.com/photo-1436491865332-7a61a109cc05?auto=format&fit=crop&q=80&w=2074", // Airplane/Sky
  "https://images.unsplash.com/photo-1500835556837-99ac94a94552?auto=format&fit=crop&q=80&w=1920", // Travel Blue theme
  "https://images.unsplash.com/photo-1506929562872-bb421503ef21?auto=format&fit=crop&q=80&w=2068"  // Beach/Resort
];
...
const ALL_SERVICES = [
  {
    ...
    desc: "Daily appointments available for Spain, France & Italy. 99% success rate.",
  ...
  },
  {
    ...
    desc: "Global flight ticketing with competitive corporate rates.",
  ...
  },
  {
    ...
    desc: "Meetings, Incentives, Conferences, and Exhibitions management.",
  ...
  },
  {
    ...
    desc: "Comprehensive planning for destination weddings and corporate events.",
  ...
  },
  {
    ...
    desc: "End-to-end travel management solutions for businesses.",
  ...
  },
  {
    ...
    desc: "Luxury stays, villas, and budget-friendly accommodation worldwide.",
...
const PACKAGES = [
  {
    ...
    inclusions: ["5 Nights Accommodation in 4* Hotels", "Daily Buffet Breakfast", "Swiss Travel Pass (8 Days)", "Visa Assistance", "Airport Transfers"],
    exclusions: ["International Flights", "Personal Expenses", "City Tax (approx CHF 3/night)", "Travel Insurance"],
    itinerary: [
      { day: 1, title: "Arrival in Zurich", desc: "Arrive at Zurich airport. Private transfer to your hotel. Spend the evening exploring the Old Town (Altstadt) and enjoy a welcome dinner by the lake." },
      { day: 2, title: "Zurich to Lucerne", desc: "Board the train to Lucerne. Upon arrival, enjoy a guided walking tour covering the Chapel Bridge and Lion Monument. Afternoon boat cruise on Lake Lucerne." },
      { day: 3, title: "Mount Titlis Adventure", desc: "Full day excursion to Mount Titlis. Experience the Rotair revolving cable car and visit the Ice Flyer chairlift." },
      { day: 4, title: "Interlaken & Jungfraujoch", desc: "Travel to Interlaken. Take the cogwheel train to Jungfraujoch - Top of Europe. Visit the Ice Palace and Sphinx Observatory." },
      { day: 5, title: "Glacier Express Route", desc: "Experience a section of the famous Glacier Express route with panoramic views of the Swiss Alps." },
      { day: 6, title: "Departure", desc: "Breakfast at hotel. Transfer to Zurich airport for your flight back home." }
    ]
  },
  {
    id: 102,
    ...
    itinerary: [
       { day: 1, title: "Arrival Kochi", desc: "Pickup from airport and transfer to hotel." },
       { day: 2, title: "Munnar", desc: "Drive to Munnar via Cheeyappara waterfalls." }
    ]
  },
  {
    id: 103,
    ...
    overview: "The perfect mix of culture and fun for the whole family.",
    highlights: ["Eiffel Tower", "Louvre Museum", "Disneyland Paris"],
    inclusions: ["Accommodation", "Park Tickets", "Transfer"],
  ...
  },
  {
    ...
    inclusions: ["5-Star Hotel", "Private Transfers", "All Tours"],
  ...
  },
  {
    ...
    labels: ["Budget", "Beach", "Honeymoon"],
    rating: 4,
    image: "https://images.unsplash.com/photo-1537996194471-e657df975ab4?auto=format&fit=crop&q=80&w=800",
    overview: "Sun, sand, and serenity in the Island of Gods.",
    highlights: ["Ubud Monkey Forest", "Tanah Lot Temple", "Kuta Beach"],
...
const TESTIMONIALS = [
  { id: 1, name: "Sarah Jenkins", location: "Manchester", text: "Got my Spain visa in just 5 days thanks to their daily appointment slots! Highly recommended.", rating: 5 },
...
const BLOG_POSTS = [
  {
    id: 1,
    title: "Top 5 Mistakes to Avoid in Schengen Visa Applications",
    slug: "schengen-visa-mistakes",
    category: "Visa Tips",
    date: "Oct 12, 2023",
    readTime: "5 min read",
    excerpt: "Applying for a Schengen visa? Avoid these common mistakes to ensure your application gets approved smoothly.",
    image: "https://images.unsplash.com/photo-1542452377-51cfa823c3c7?auto=format&fit=crop&q=80&w=800",
    content: "Content placeholder..."
  },
  {
    id: 2,
    title: "Best Budget Family Destinations for 2024",
    slug: "family-destinations-2024",
    category: "Destinations",
    date: "Nov 05, 2023",
    readTime: "7 min read",
    excerpt: "Planning your next family getaway? Here are the top destinations that cater to both kids and adults without breaking the bank.",
    image: "https://images.unsplash.com/photo-1511632765486-a01980e01a18?auto=format&fit=crop&q=80&w=800",
    content: "Content placeholder..."
  },
  {
    id: 3,
    title: "MICE Travel Trends",
    slug: "mice-travel-trends",
    category: "Corporate",
    date: "Nov 20, 2023",
    readTime: "6 min read",
    excerpt: "How corporate events are evolving in the post-pandemic world.",
...
const Button = ({ children, variant = 'primary', className = '', ...props }: any) => {
  ...
  const styles = {
    primary: "bg-gradient-to-r from-blue-600 to-cyan-500 text-white hover:shadow-lg hover:shadow-blue-500/30 border border-transparent",
    secondary: "bg-white text-gray-800 border border-gray-200 hover:border-blue-500 hover:text-blue-600 hover:bg-blue-50",
...
const Section = ({ className = '', children, bg = 'white' }: any) => (
  <section className={`py-16 md:py-24 ${bg === 'gray' ? 'bg-gray-50' : bg === 'dark' ? 'bg-slate-900' : 'bg-white'} ${className}`}>
    {children}
  </section>
);
  ...
  <form className="space-y-5" onSubmit={(e) => { e.preventDefault(); alert("Enquiry Sent!"); }}>
    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
      <div>
        ...
        <div className="relative">
            ...
            <input type="text" className="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none" placeholder="John Doe" />
        </div>
      </div>
      <div>
        ...
        <div className="relative">
            ...
            <input type="tel" className="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none" placeholder="+44 7700 900000" />
        </div>
      </div>
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
      <div>
        ...
        <div className="relative">
            ...
            <input type="email" className="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none" placeholder="john@example.com" />
        </div>
      </div>
      <div>
        ...
        <div className="relative">
            ...
            <select className="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none bg-white">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div>
          ...
          <input type="text" className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none" placeholder="e.g. Paris" />
        </div>
        <div>
    ...
    <div>
      ...
      <textarea rows={4} className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none" placeholder="Tell us about your preferences, number of passengers, etc..." />
    </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
             <div className="space-y-1">
               ...
               <div className="flex items-center gap-2 border-b-2 border-gray-200 pb-2">
                 ...
                 <input type="text" placeholder="Manchester (MAN)" className="w-full bg-transparent outline-none text-gray-900 font-medium placeholder-gray-400" />
               </div>
             </div>
             <div className="space-y-1">
               ...
               <div className="flex items-center gap-2 border-b-2 border-gray-200 pb-2">
                 <MapPin className="w-5 h-5 text-blue-500" />
                 <input type="text" placeholder="Dubai (DXB)" className="w-full bg-transparent outline-none text-gray-900 font-medium placeholder-gray-400" />
               </div>
             </div>
             <div className="space-y-1">
               ...
               <div className="flex items-center gap-2 border-b-2 border-gray-200 pb-2">
                 ...
                 <input type="date" className="w-full bg-transparent outline-none text-gray-900 font-medium" />
               </div>
             </div>
             <Button className="w-full h-12 shadow-blue-500/50" onClick={() => navigate('/contact')}>Search Flights</Button>
           </div>
        )}
...
const HomePage = () => {
  ...
  return (
    <>
      {/* Hero Section (Reverted to Single Image) */}
      ...
      {/* Find Your Perfect Trip (Trending Destinations) - SEPARATE SECTION */}
      <Section>
        <Container>
      ...
      {/* Budget Friendly Destinations (With Tabs) - SEPARATE SECTION */}
      <Section bg="gray">
        <Container>
